...
def make_script(marker_list, feat_list=[]):
	...
	with open(sd_name + ".sh", 'w') as F:
		...
		print("time python3 %s -p ../max/data.pickle -b max -t class 2>&1 %s | tee output.txt" % (prog, extra_args), file=F)
		print("", file=F)
		print("cd ..", file=F)
		print("", file=F)
		...
		print("time python3 %s -p ../max/data.pickle -b max -t multi 2>&1 %s | tee output.txt" % (prog, extra_args), file=F)
		print("", file=F)
		print("cd ..", file=F)
		print("", file=F)
		...
		print("time python3 %s -p ../max/data.pickle -b min -t class 2>&1 %s | tee output.txt" % (prog, extra_args), file=F)
		print("", file=F)
		print("cd ..", file=F)
		print("", file=F)
		...
		print("time python3 %s -p ../max/data.pickle -b min -t multi 2>&1 %s | tee output.txt" % (prog, extra_args), file=F)
		print("", file=F)
		print("cd ..", file=F)
		print("", file=F)
		for feat_num in feat_list:
			...
			print("", file=F)
			print("mkdir %s && cd %s" % (folder_name, folder_name), file=F)
			print("time python3 %s -p ../max/data.pickle -n %d -t class 2>&1 %s | tee output.txt" % (prog, feat_num, extra_args), file=F)
			print("", file=F)
			print("cd ..", file=F)
			print("", file=F)
			...
			print("", file=F)
			print("mkdir %s && cd %s" % (folder_name, folder_name), file=F)
			print("time python3 %s -p ../max/data.pickle -b min -n %d -t class 2>&1 %s | tee output.txt" % (prog, feat_num, extra_args), file=F)
			print("", file=F)
			print("cd ..", file=F)
			print("", file=F)
			...
			print("", file=F)
			print("mkdir %s && cd %s" % (folder_name, folder_name), file=F)
			print("time python3 %s -p ../max/data.pickle -n %d -t multi 2>&1 %s | tee output.txt" % (prog, feat_num, extra_args), file=F)
			print("", file=F)
			print("cd ..", file=F)
			print("", file=F)
			...
			print("", file=F)
			print("mkdir %s && cd %s" % (folder_name, folder_name), file=F)
			print("time python3 %s -p ../max/data.pickle -b min -n %d -t multi 2>&1 %s | tee output.txt" % (prog, feat_num, extra_args), file=F)
			print("", file=F)
			print("cd ..", file=F)
			print("", file=F)
